...
categories: [diary]
tags: [india, udaipur, solo-travel]
series: udaipur-diaries
background: '/img/indian-diaries/udaipur/banner.jpg'
excerpt: "How a nosedived interview turned into a spontaneous trip to Udaipur - and why the city of lakes is worth every one of those 16 hours on the train."
redirect_from:
  - /india/travel/2020/08/14/udaipur.html
  - /india/travel/2020/08/15/udaipur.html
---
...
<picture>
      <source media="(min-width: 480px)" srcset="{{ site.baseurl }}/assets/resized/480/train-journey.jpg" />
      <source media="(min-width: 800px)" srcset="{{ site.baseurl }}/assets/resized/800/train-journey.jpg" />
      <source media="(min-width: 1400px)" srcset="{{ site.baseurl }}/assets/resized/1400/train-journey.jpg" />
  <img src="{{ site.baseurl }}/img/indian-diaries/udaipur/train-journey.jpg" alt="View from the train" class="center" />
</picture>
...
<picture>
      <source media="(min-width: 480px)" srcset="{{ site.baseurl }}/assets/resized/480/dolls.jpg" />
      <source media="(min-width: 800px)" srcset="{{ site.baseurl }}/assets/resized/800/dolls.jpg" />
      <source media="(min-width: 1400px)" srcset="{{ site.baseurl }}/assets/resized/1400/dolls.jpg" />
  <img src="{{ site.baseurl }}/img/indian-diaries/udaipur/dolls.jpg" alt="Hostel Decor" class="center" />
</picture>
